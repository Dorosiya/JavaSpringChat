...
import portfolio.chatApplication.member.dto.request.LoginDto;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException, ServletException {
        ...
        String accessToken = jwtUtil.createJwt("access", memberId, username, role, 1800000L);
        String refreshToken = jwtUtil.createJwt("refresh", memberId, username, role, 60*60*1000*24*14L);
