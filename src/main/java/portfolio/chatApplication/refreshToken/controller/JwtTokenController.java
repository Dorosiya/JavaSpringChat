package portfolio.chatApplication.refreshToken.controller;
...
public class JwtTokenController {
    ...
    public ResponseEntity<?> reissue(HttpServletRequest request, HttpServletResponse response) {
        ...
        // jwt
        String newAccess = jwtUtil.createJwt("access", memberId, username, role, 1800000L);
        String newRefresh = jwtUtil.createJwt("refresh", memberId, username, role, 86400000L);
